...
/*
    ...
    ***** Game State *****
    ...
    We shall define a nested static enumeration to represent the game states in the GameMain class (GameTemplate)
...
public class GameTemplate extends JPanel {       // main class for the game
    ...
    static final String TITLE = "GameTemplate";  // title of the game
