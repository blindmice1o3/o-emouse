...
public class ChessGame extends JPanel
    ...
    */
    ...
    public void paintComponent(Graphics g) {
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ImageIcon imageIconWolfman = new ImageIcon("src/count_zero_init/model/icons/wolfman.png");
        Image imageWolfman = imageIconWolfman.getImage();
        g.drawImage(imageWolfman, 210 + 5, 280 + 5, 280 - 5, 350 - 5, 0, 0, 256, 256, null);

        ImageIcon imageIconFishmonk = new ImageIcon("src/count_zero_init/model/icons/3fish_blue_spirit.png");
        Image imageFishmonk = imageIconFishmonk.getImage();
        g.drawImage(imageFishmonk, 280 + 5, 280 + 5, 350 - 5, 350 - 5, 0, 0, 256, 256, null);

        ImageIcon imageIconRobot = new ImageIcon("src/count_zero_init/model/icons/robot_flat_head.png");
        Image imageRobot = imageIconRobot.getImage();
        g.drawImage(imageRobot, 210 + 5, 210 + 5, 280 - 5, 280 - 5, 0, 0, 256, 256, null);

        ImageIcon imageIconMonkey = new ImageIcon("src/count_zero_init/model/icons/5monkey.jpg");
