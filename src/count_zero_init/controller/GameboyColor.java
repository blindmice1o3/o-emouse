...
import count_zero_init.model.map.ForestMap;
    ...
    public static void main (String[] args) {
        SwingUtilities.invokeLater( new Runnable() {
            public void run() {
                ...
                // The count_zero_init's upButtonPressed() is called to change the player's row variable to decrement by two and
        ...
        /*
        // The count_zero_init's startButtonPressed() is called to change the currentGameState to StartMenuState, then is
        ...
        */
        ...
        System.out.println("Player1's inventory: " + player1.getMyItemList());
